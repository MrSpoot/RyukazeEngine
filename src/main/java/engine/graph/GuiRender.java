...
public class GuiRender {
    ...
    public GuiRender(Window window) {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("resources/shaders/vertex/gui.vert", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("resources/shaders/fragment/gui.frag", GL_FRAGMENT_SHADER));
